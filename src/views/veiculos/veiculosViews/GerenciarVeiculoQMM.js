        ...
        <View style={styles.container}>
            ...
            <View style={{
                ...
                <View style={{ flexDirection: 'column', marginTop: 0 }}>
                    ...
                    <Text style={styles.content}>QMM-2353</Text>
                </View>
                <View
                    style={styles.linha}
                />
                ...
                <View style={{ flexDirection: 'column', marginTop: 8 }}>
                    ...
                    <Text style={styles.content}>Preto</Text>
                </View>
                <View
                    style={styles.linha}
                />
                ...
                <ScrollView>
                    <View style={{ flexDirection: 'row', marginTop: 0 }}>
                        ...
                        <Text style={{ marginTop: 40, marginBottom: 4, marginLeft: 165, alignSelf: 'flex-end', fontWeight: 'bold', color: '#004B8D', fontSize: 20, }}>Indisponível</Text>
                    </View>
