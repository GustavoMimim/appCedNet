        ...
        <View style={styles.container}>
            ...
            <View style={{
                ...
                <View style={{ flexDirection: 'column', marginTop: 0 }}>
                    ...
                    <Text style={styles.content}>Thainá Toga Romero</Text>
                </View>
                <View
                    style={styles.linha}
                />
                <View style={{ flexDirection: 'column', marginTop: 8 }}>
                    ...
                    <Text style={styles.content}>Técnica em manutenção</Text>
                </View>
                <View
                    style={styles.linha}
                />
                <View style={{ flexDirection: 'column', marginTop: 8 }}>
                    ...
                    <Text style={styles.content}>manutencao@cednet.com.br</Text>
                </View>
                <View
                    style={styles.linha}
                />
                <View style={{ flexDirection: 'column', marginTop: 8 }}>
                    ...
                    <Text style={styles.content}>(14) 3322-8887</Text>
                </View>
                <View
                    style={styles.linha}
                />
                <View style={{ flexDirection: 'column', marginTop: 8 }}>
                    ...
                    <Text style={styles.content}>(14) 97566-9746</Text>
                </View>
                <View
                    style={styles.linha}
                />
