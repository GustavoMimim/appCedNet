        ...
        <View style={styles.container}>
            ...
            <View style={{
                ...
                <View style={{ flexDirection: 'column', marginTop: 0 }}>
                    ...
                    <Text style={styles.content}>Aline Oliveira Pereira</Text>
                </View>
                <View
                    style={styles.linha}
                />
                <View style={{ flexDirection: 'column', marginTop: 8 }}>
                    ...
                    <Text style={styles.content}>Técnica em redes</Text>
                </View>
                <View
                    style={styles.linha}
                />
                ...
                <View style={{ flexDirection: 'column', marginTop: 8 }}>
                    ...
                    <Text style={styles.content}>(14) 3322-1111</Text>
                </View>
                <View
                    style={styles.linha}
                />
                <View style={{ flexDirection: 'column', marginTop: 8 }}>
                    ...
                    <Text style={styles.content}>(14) 97566-7949</Text>
                </View>
                <View
                    style={styles.linha}
                />
